...
-- CreateEnum
CREATE TYPE "GoalStatus" AS ENUM ('DRAFT', 'ON_TRACK', 'AT_RISK', 'COMPLETED');

-- CreateEnum
CREATE TYPE "ItemStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'REVIEW', 'DONE');

-- CreateEnum
CREATE TYPE "Priority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'PIN', 'UNPIN', 'INVITE', 'ACCEPT_INVITE', 'REVOKE_INVITE', 'ROLE_CHANGE', 'REMOVE_MEMBER');
...
-- CreateIndex
CREATE INDEX "Goal_workspaceId_dueDate_idx" ON "Goal"("workspaceId", "dueDate");
...
-- CreateIndex
CREATE INDEX "ActionItem_workspaceId_assigneeId_idx" ON "ActionItem"("workspaceId", "assigneeId");

-- CreateIndex
CREATE INDEX "ActionItem_workspaceId_dueDate_idx" ON "ActionItem"("workspaceId", "dueDate");
